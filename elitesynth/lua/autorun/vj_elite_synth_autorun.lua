...
-- Addon Information(Important!):
	local PublicAddonName = "Super Soldier"
	local AddonName = "Elite_Synth_Npc"
...
if( file.Exists( VJExists, "GAME" ) ) then
	...
	AddCSLuaFile("autorun/vj_elite_synth_autorun.lua")
	AddCSLuaFile("autorun/vj_elite_synth_convar.lua")
	AddCSLuaFile("autorun/vj_elite_synth_spawn.lua")
	VJ.AddAddonProperty(AddonName,AddonType)
end

if CLIENT then
if (!file.Exists("autorun/vj_elite_synth_autorun.lua","LUA")) then
